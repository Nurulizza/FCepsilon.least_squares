...
bounds_dictionary = {'FCepsilonRI/k_f1': [-5,2], 'FCepsilonRI/k_f2': [-5,2],'FCepsilonRI/k_f3': [-5,2], 'FCepsilonRI/k_f4': [-5,2],
	 'FCepsilonRI/k_f5': [-5,2], 'FCepsilonRI/k_r1': [-10,-9], 'FCepsilonRI/k_r3': [-10,-9], 'FCepsilonRI/k_r5': [-10,-9], 'FCepsilonRI/k_f6': [-0.03,-0.027]} # 
...
class Simulation(object):
    def __init__(self):
        ...
        #self.problem = {
        #           'num_vars': len(bounds_dictionary),
        #           'names': bounds_dictionary.keys(),
        #           'bounds': bounds
        #          }
        ...
        self.problem = {
                   ...
                   'names': ['FCepsilonRI/k_f1', 'FCepsilonRI/k_f2','FCepsilonRI/k_f3', 'FCepsilonRI/k_f4','FCepsilonRI/k_f5',
                             'FCepsilonRI/k_r1', 'FCepsilonRI/k_r3', 'FCepsilonRI/k_r5', 'FCepsilonRI/k_f6'],
                   'bounds': [[-5,2], [-5,2], [-5,2], [-5,2], [-5,2], [-10,-9], [-10,-9], [-10,-9], [-0.03,-0.027]]
                   }
                   
        # Generate Samples
        self.samples = saltelli.sample(self.problem, 10) #Generate no of sample using N*(2D+2) where N is the supplied argument and D is no of constant
    ...
    def evaluate_ssq(self, parameter_values):
        ...
        #print('Parameter set1: ', self.constants)
        self.simulation.run()
    ...
    def plot_n_best(self,n,param_sweep_results):
        #print('a',param_sweep_results[0:5,:])
        for i in range(0,n):
            self.simulation.clearResults()
            self.simulation.resetParameters()
            #print ('a',self.model_constants)
            #print ('b',param_sweep_results)
